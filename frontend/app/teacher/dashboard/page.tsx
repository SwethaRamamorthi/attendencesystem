...
export default function TeacherDashboard() {
  ...
  const teacherMenuItems = [
    ...
    },
    {
      ...
      description: "Create and manage class timetables with subjects and teachers",
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {teacherMenuItems.map((item, idx) => (
              <div
                ...
                className={`relative p-6 rounded-2xl border-2 transition-all duration-500 cursor-pointer group overflow-hidden bg-white hover:shadow-xl ${item.borderColor
