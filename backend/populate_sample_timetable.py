...
# UPDATED: Based on fully aggregated timetable provided by user
...
def populate():
    ...
    # CLEAR EXISTING DATA to remove junk/old entries
    print("Clearing existing timetables collection...")
    ...
    for dept_variant in target_depts:
        ...
        for year_variant in target_years:
            ...
            for data in timetables_data:
                ...
                # Check if exists (it shouldn't since we cleared, but logic kept for safety)
